...
3. Using vanilla JavaScript means that I have no way of automatically binding my HTML to my code and instead need to imperatively grab the DOM elements. This obviously will not scale very well in the longterm and is something I hope to address when using a web framework.
